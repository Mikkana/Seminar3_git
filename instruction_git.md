...
![Git emblem](Image\gitcat.jpg =200x200)
...
Для того, чтобы сменить ветку с одной на другую, нужно использовать ту же команду, с помощью которой осуществляется переход с одной версии на другую. Только вместо хэшированного идентификатора версии нужно прописать имя ветки:
